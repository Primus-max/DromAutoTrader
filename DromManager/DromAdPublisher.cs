namespace DromAutoTrader.DromManager
{
    ...
    public class DromAdPublisher
    {
        ...
        #region Блок редактирования объявления

        //public void GetIdFromAd(string articul)
        //{
        //    GetDromeIdFromAd( articul);
        //}

        //// Получаю список объявлений, беру первое
        //private void GetDromeIdFromAd(string articul)
        //{
        //    WebDriverWait wait = new(_driver, TimeSpan.FromSeconds(7));
        //    try
        //    {
        //        Thread.Sleep(500);
        //        string searchUrl = new("https://baza.drom.ru/personal/actual/bulletins?find=");
        //        string fullUrl = $"{searchUrl}{articul}";
        ...
        //        {
        //            // Нахожу родителя
        //            var adCard = wait.Until(e => e.FindElements(By.CssSelector("tr.bull-item.bull-item_inline")))[0];

        //            // Найти дочерний элемент <a> 
        //            var aElement = adCard.FindElement(By.CssSelector("a.bulletinLink.bull-item__self-link.auto-shy"));

        //            // Извлечение значения атрибута "name" из дочернего элемента <a>
        //            string nameAttributeValue = aElement.GetAttribute("name");
        //            int dromeId = Convert.ToInt32(nameAttributeValue); 
        //            using var context = new AppContext();
        //            var existingAd = context.AdPublishingInfo.FirstOrDefault(d => d.Artikul == articul); 

        //            if(existingAd != null)
        //            {
        //                existingAd.InputPrice = existingAd.InputPrice;
        //                existingAd.OutputPrice = existingAd.OutputPrice;
        //                existingAd.Brand = existingAd.Brand;
        //                existingAd.Artikul = existingAd.Artikul;
        //                existingAd.DatePublished = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
        //                existingAd.AdDescription = existingAd.AdDescription;
        //                existingAd.Count = existingAd.Count;
        //                existingAd.ImagesPath = existingAd.ImagesPath;
        //                existingAd.IsArchived = existingAd.IsArchived;
        //                existingAd.KatalogName = existingAd.KatalogName;
        //                existingAd.PriceName = existingAd.PriceName;
        //                existingAd.Description = existingAd.Description;
        //                existingAd.PriceBuy = existingAd.PriceBuy;
        //                existingAd.DromeId = dromeId;
        //            }
        ...
        //    }
        //    //MessageBox.Show($"Работу закончил");
        //}
        #endregion
